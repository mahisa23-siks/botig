...
// ig : @mahisa23
// fb : @mahisa23
// websitte : www.siksonline.com and www.hokilagi.com
...
const main = async () => {
  ...
  Ξ TITLE  : BOT INSTAGRAM
  Ξ UPLOAD : 29/08/2019 [16.28 WIB]
  Ξ CODEBY : mahisa23 [CrossX]
  }`);
  ...
  Ξ THANKS : BOT INSTAGRAM [Original Source File]
           : mahisa23-siks}`);
  console.log('\n')
  main();
